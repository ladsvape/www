...
compress_html:
  blanklines: true
---
var urlsToCache = ['/assets/main.css'];

{% for static_file in site.static_files %}
  {% if static_file.extname == '.js' or static_file.extname == '.png' or static_file.extname == '.jpg' %}
    urlsToCache.push("{{ static_file.path }}");
  {% endif %}
{% endfor %}
...
{% for page in site.pages %}
  {% if page.sitemap == nil or page.sitemap == true %}
    {% if page.permalink %}
          urlsToCache.push("{{ page.permalink }}");
    {% endif %}
...
var CACHE_NAME = '{{ site.title | slugify }}-cache-{{ site.cacheversion }}';
